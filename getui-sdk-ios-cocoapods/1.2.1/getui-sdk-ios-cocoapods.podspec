...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "个推实验室" => "support@getui.com" }
  ...
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-sdk-ios-cocoapods.git", :tag => "1.2.1" }
  ...
  s.preserve_paths = "libGeTuiSdk-1.2.1.a"
  s.ios.vendored_library = "libGeTuiSdk-1.2.1.a"
 ...
 s.framework  = "UIKit"
  ...
  s.frameworks = 'UIKit', 'MapKit', 'Security','SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation'
  s.ios.frameworks = 'UIKit', 'MapKit', 'Security','SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation'
  # s.library   = "sqlite3"
