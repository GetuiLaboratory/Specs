...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-sdk-ios-cocoapods.git", :tag => "1.3.0" }
  ...
  s.preserve_paths = "libGeTuiSdk-1.3.0.a"
  s.ios.vendored_library = "libGeTuiSdk-1.3.0.a"
