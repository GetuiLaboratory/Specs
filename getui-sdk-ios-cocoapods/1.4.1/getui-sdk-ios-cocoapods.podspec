...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-sdk-ios-cocoapods.git", :tag => "1.4.1" }
  ...
  s.preserve_paths = "libGeTuiSdk-1.4.1.a"
  s.ios.vendored_library = "libGeTuiSdk-1.4.1.a"
  ...
  s.frameworks = 'SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation','CoreBluetooth','JavaScriptCore','Security'
  s.ios.frameworks = 'SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation','CoreBluetooth','JavaScriptCore','Security'
  # s.library   = "sqlite3"
