...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-sdk-ios-cocoapods.git", :tag => "1.4.2-noidfa" }
  ...
  s.frameworks = 'SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation','CoreBluetooth','JavaScriptCore','Security','MobileCoreServices'
  s.ios.frameworks = 'SystemConfiguration', 'CFNetwork','CoreTelephony','CoreLocation','AVFoundation','CoreBluetooth','JavaScriptCore','Security','MobileCoreServices'
  # s.library   = "sqlite3"
